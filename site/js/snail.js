...
class SnailGame {
    constructor(canvas, ctx) {
        ...
        // player info
        this.user = new SnailPlayer(0, 0, 0, 0x0);
        this.players = [this.user];

        // user specific info
        this.lastinputspace = false;
        ...
        //DEBUG TEMP STUFF
        this.players.push(new SnailPlayer(200, 200, 0, "red"));
        this.players.push(new SnailPlayer(200, 0, 0, "red"));
    }
    ...
    insertCharacter(inchar) {
        ...
        if (inchar == ' ') {
            if (this.lastinputspace) {
                return false;
            } else {
                this.lastinputspace = true;
            }
        } else {
            this.lastinputspace = false;
        }
